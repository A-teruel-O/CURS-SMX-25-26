...
Heu de produir dos vídeos amb les següents especificacions:
...
- Conceptes bàsics: una introducció a la protecció de dades de caràcter personal.
...
- Tractament físic: destrucció de documents amb trituradora i no amb paperera convencional.
...
- Cessió de dades: diferència entre Responsable de Tractament (FoodLogistic) i Encarregat de Tractament (la gestoria de nòmines).
...
- Guions tècnics dels dos vídeos.
- Llistat de fonts consultades: URL específiques de documents, no genèriques, i referències a documents.
- Arxius de vídeo:
  - Dos vídeos de durada compresa entre 5 i 6 minuts.
  - Compartits via YouTube, Google Vids, Drive, etc.
  - Es valorarà la claredat de l'àudio, l'ús de rètols per emfatitzar conceptes clau i l'originalitat. Poden ser animacions, gravacions reals o presentacions dinàmiques locutades.

Entrega:
- [Guions dels videos](guions.md)
...
[Drets dels ciutadans: ARSULIPO AEPD](https://www.aepd.es/es/derechos-y-deberes/conoce-tus-derechos)

[La protecció de dades en les relacions laborals AEPD](https://www.aepd.es/guias/la-proteccion-de-datos-en-las-relaciones-laborales.pdf)
...
[Guía de seguridad del tratamiento de datos personales AEPD](https://www.aepd.es/guias/guia-proteccion-datos-por-defecto.pdf)

[Reglamento (UE) 2016/679 relativo a la protección de las personas físicas (RGPD) BOE](https://www.boe.es/buscar/doc.php?id=DOUE-L-2016-80807)

[Guía sobre el deber de informar AEPD](https://www.aepd.es/sites/default/files/2019-09/guia-modelo-clausula-informativa.pdf)

[Guía para la gestión y notificación de brechas de seguridad AEPD](https://www.aepd.es/guias/guia-brechas-seguridad.pdf)
